#modules
import pyttsx3 as py #text to speeech
...
if __name__ =="__main__":#main body
    while True:#cotinously takes input from user
        ...
        # if 'jarvis' or 'computer' in query:#checks if jarvis is said to continue the program
        ...
        if 'wikipedia' in query:#search in wikipedia
            ...
            if "yes" in query1:
                results=wp.summary(query,sentences=6)
                speak(results)
            elif "no" in query1:
                speak("OK")
            else:
        ...
        elif ''in query:#greetings
            greetings=["Hello there, What can i help you with" , 
                        "Hey what's up, wan't some help with something?" ,
            ...
            if 'youtube' in query:#youtube
                ...
                wb.open('youtube.com')
            elif 'gta'or 'gta V':#gta V
                os.startfile("C:\\gg\\G\\Grand Theft Auto V.url")
                speak("opening Gta five")
